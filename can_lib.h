...
typedef enum {
  ...
  CMD_REPLY_MASKED,
  CMD_ABORT,
  CMD_RX_DATA_DEFINED_MASK//To use different masks. Added by Laszlo Kis
} can_cmd_t; 
...
typedef  struct{
  ...
  can_cmd_t  cmd; 
  can_id_t   id;
  can_id_t   id_mask; //To use different masks. Added by Laszlo Kis
  U8         dlc;  
  U8*        pt_data; 
  U8         status; 
  can_ctrl_t ctrl;   
