...
void can_init( void)
	...
	//250k, 75% sample, Tbit=16 (fclk = 8MHz)
	CANBT1 = 0x02;
	CANBT2 = 0x0C;
	CANBT3 = 0x37;
	...
	CANGCON |= 0x02;
	CANGIE=(1<<ENIT) | (1<< ENRX) /*| (1<<ENERR) | (1<<ENERG)*/; //currently modified: ENERR and ENERG added
	CANIE2 = 0xFF;			//only used in debugging
	CANIE1 = 0x7F;			//only used in debugging
}
